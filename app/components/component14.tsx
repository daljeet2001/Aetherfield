...
export default function Component14(){
    ...
    return(
        <div className="flex flex-col items-center gap-5 py-30 px-5 w-full">

            <div className="flex items-end justify-between border-box w-full">

                <h2 className="text-[56px] font-medium leading-[1] tracking-[-0.03em] [font-family:var(--font-radio-canada-big)]">Recent articles</h2>

                <motion.p onClick={()=>router.push("/journal")} whileHover={{opacity:0.6}} transition={{ duration: 0.2, ease: "easeOut" }} className="cursor-pointer text-xl leading-[1.2] tracking-[-0.04em] [font-family:var(--font-source-serif-4)] underline">View all articles</motion.p>

            </div>

            <div className="grid grid-cols-3 gap-4">

                    <motion.div onClick={()=>router.push("/article/how-to-build-a-climate-ready-data-stack",{scroll:true})} whileHover="hover" transition={{ duration: 0.2, ease: "easeOut" }} className="flex flex-col items-start gap-5 border-box  w-full cursor-pointer">

                    <div className="bg-[url('/x9.avif')] bg-cover bg-center h-[271.07px] w-full"></div>
                  ...
                  <motion.div onClick={()=>router.push("/article/how-to-build-a-climate-ready-data-stack")} whileHover="hover" transition={{ duration: 0.2, ease: "easeOut" }} className="flex flex-col items-start gap-5 border-box  w-full cursor-pointer">
                    ...
                    <div className="bg-[url('/x11.avif')] bg-cover bg-center h-[271.07px] w-full"></div>
                ...
                <motion.div onClick={()=>router.push("/article/how-to-build-a-climate-ready-data-stack")}  whileHover="hover" transition={{ duration: 0.2, ease: "easeOut" }} className="flex flex-col items-start gap-5 border-box  w-full cursor-pointer">
                    ...
                    <div className="bg-[url('/x8.avif')] bg-cover bg-center h-[271.07px] w-full"></div>
