...
export default function Component9(){
    return(
        <div className="flex flex-col items-center gap-8 border-box py-10 md:py-20 lg:py-30 px-5 bg-[#F6F8FB]">
            ...
            <h4 className="font-medium text-2xl md:text-[32px] lg:text-[40px] leading-[1] tracking-[-0.03em] [font-family:var(--font-radio-canada-big)]">Subscribe to Aetherfield Journal</h4>
