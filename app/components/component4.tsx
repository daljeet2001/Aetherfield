...
export default function Component4() {
    return (
        <div className="h-[678px] w-full bg-[url('/x3.webp')] bg-cover bg-center flex flex-col items-center gap-10 py-30 px-5">

            <div className="flex flex-col items-end border-box pb-2">
            ...
            <div className="flex items-start gap-4 border-box">
