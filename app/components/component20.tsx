...
export default function Component20() {
    ...
    return (
        ...
        <div className="flex flex-col items-center gap-10 border-box pt-[140px] px-5 pb-30 bg-linear-to-b from-[#A8D3FF]  to-[#FFF4DF]">
            ...
            <motion.p onClick={() => router.push('/careers')} whileHover={{ opacity: 0.6 }} transition={{ duration: 0.2, ease: "easeOut" }} className="text-xl leading-[1.2] tracking-[-0.04em] [font-family:var(--font-source-serif-4)] cursor-pointer">
                ← Back to Careers
            </motion.p>

            <div className="flex flex-col items-start gap-12 p-10 border-box rounded-2xl bg-white w-[820px] relative">

                 <div className="bg-[url('/x16.svg')] rotate-8 bg-cover bg-center w-[313.69px] h-[182.22px] absolute right-[-85px] bottom-[270px] z-[300]"></div>
