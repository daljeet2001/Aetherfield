...
export default function Component20() {
    ...
    return (
        ...
        <div className="flex flex-col items-center gap-6 md:gap-10 box-border pt-30 md:pt-[140px] px-5 pb-30 bg-linear-to-b from-[#A8D3FF]  to-[#FFF4DF]">

            <motion.p variants = {item1} initial = "hidden" whileInView = "show" viewport = {{once:true}} onClick={() => router.push('/careers')} whileHover={{ opacity: 0.6 }} transition={{ duration: 0.2, ease: "easeOut" }} className="text-lg md:text-xl leading-[1.2] tracking-[-0.04em] [font-family:var(--font-source-serif-4)] cursor-pointer">
                ← Back to Careers
            </motion.p>
            ...
            <motion.div className="relative">
                ...
                <motion.div variants = {item3} initial = "hidden" whileInView = "show" viewport = {{once:true}} className="hidden md:block bg-[url('/x16.svg')]  bg-cover bg-center md:w-[247.09px] lg:w-[313.69px] md:h-[143.52px] lg:h-[182.22px] absolute md:right-[-50px] lg:right-[-85px] bottom-[270px] z-[50]"></motion.div>

                <motion.div variants = {item2} initial = "hidden" whileInView = "show" viewport = {{once:true}} className="flex flex-col items-start  gap-8 md:gap-12 pt-6 md:pt-10 px-6  md:px-10 pb-8 md:pb-10 border-box rounded-2xl bg-white w-full md:w-[720px]  lg:w-[820px] relative">



                    <div className="flex flex-col lg:flex-row items-start gap-6 md:gap-8 lg:gap-10">

                        <div className="flex flex-col items-start gap-6 border-box w-full lg:w-[600.4px]">

                            <div className="flex flex-col items-start gap-2 border-box">

                                <h2 className="text-2xl md:text-[32px] lg:text-[40px] font-medium leading-[1] tracking-[-0.03em] [font-family:var(--font-radio-canada-big)]">Data Scientist</h2>

                                <div className="flex items-start gap-2 border-box">

                                    <p className="text-[#6C6C6C] text-lg md:text-xl leading-[1.2] tracking-[-0.04em] [font-family:var(--font-source-serif-4)]">Full-time</p>
                                    <p className="text-[#6C6C6C] text-lg md:text-xl leading-[1.2] tracking-[-0.04em] [font-family:var(--font-source-serif-4)]">.</p>
                                    <p className="text-[#6C6C6C] text-lg md:text-xl leading-[1.2] tracking-[-0.04em] [font-family:var(--font-source-serif-4)]">Denver, CO</p>
                    ...
                    <div>
                        ...
                        <h5 className="text-lg md:text-xl font-medium leading-[1] tracking-[-0.02em] [font-family:var(--font-radio-canada-big)]"><span>Company description</span></h5>
                        <br />
                        ...
                        <h5 className="text-lg md:text-xl font-medium leading-[1] tracking-[-0.02em] [font-family:var(--font-radio-canada-big)]"><span>About the role</span></h5>
                        <br />
                        ...
                        <h5 className="text-lg md:text-xl font-medium leading-[1] tracking-[-0.02em] [font-family:var(--font-radio-canada-big)]"><span>Requirements</span></h5>
                        <br />
                        <p className="text-lg md:text-xl leading-[1.4] tracking-[-0.04em] [font-family:var(--font-source-serif-4)]"><span>3+ years of experience in data science or applied analytics (Python, SQL, etc.)<br />
                        ...
                        <h5 className="text-lg md:text-xl font-medium leading-[1] tracking-[-0.02em] [font-family:var(--font-radio-canada-big)]"><span>Company benefits</span></h5>
                        <br />
                        <p className="text-lg md:text-xl leading-[1.4] tracking-[-0.04em] [font-family:var(--font-source-serif-4)]"><span>Competitive salary and equity options<br />
                    ...
                    <div className="flex flex-col items-center gap-6 border-box w-full">
                        ...
                        <h2 className="font-medium text-2xl md:text-[32px] lg:text-[40px] leading-[1] tracking-[-0.03em] [font-family:var(--font-radio-canada-big)] text-center">Ready to help build the<br />future of climate intelligence?</h2>
