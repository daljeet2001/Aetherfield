        ...
        <motion.div variants = {container} initial = "hidden" animate = "show" className="flex flex-col items-center gap-10 border-box pt-[140px] px-5 pb-30 bg-linear-to-b from-[#A8D3FF]  to-[#FFF4DF]">
            ...
            <motion.div variants = {item}  className="flex flex-col items-center gap-4 border-box ">
                ...
                <div className="flex items-start gap-6 p-10 border-box bg-white rounded-2xl w-[820px]">
                    ...
                    <div className="flex flex-col items-start gap-6 border-box w-[616.4px]">

                        <div className="flex flex-col items-start gap-2 border-box">

                            <h2 className="text-xl font-medium leading-[1] tracking-[-0.02em] [font-family:var(--font-radio-canada-big)]">UX Designer</h2>
                        ...
                        <p className="text-xl leading-[1.2] tracking-[-0.04em] [font-family:var(--font-source-serif-4)]">Shape the tools that drive climate intelligence. You’ll lead cross-functional teams to build thoughtful, scalable solutions for sustainability-forward organizations.</p>
                  ...
                  <div className="flex items-start gap-6 p-10 border-box bg-white rounded-2xl w-[820px]">
                    ...
                    <div className="flex flex-col items-start gap-6 border-box w-[616.4px]">
                        ...
                        <div className="flex flex-col items-start gap-2 border-box">
                            ...
                            <h2 className="text-xl font-medium leading-[1] tracking-[-0.02em] [font-family:var(--font-radio-canada-big)]">Data Scientist</h2>
                  ...
                  <div className="flex items-start gap-6 p-10 border-box bg-white rounded-2xl w-[820px]">
                    ...
                    <div className="flex flex-col items-start gap-6 border-box w-[616.4px]">
                        ...
                        <div className="flex flex-col items-start gap-2 border-box">
                            ...
                            <h2 className="text-xl font-medium leading-[1] tracking-[-0.02em] [font-family:var(--font-radio-canada-big)]">Product Manager</h2>
                  ...
                  <div className="flex items-start gap-6 p-10 border-box border border-dashed border-black  rounded-2xl w-[820px]">

                    <div className="flex flex-col items-start gap-6 border-box  w-[616.4px]">

                        <div className="flex flex-col items-start gap-2 border-box">

                            <h2 className="text-xl font-medium leading-[1] tracking-[-0.02em] [font-family:var(--font-radio-canada-big)]">Open application</h2>
                        ...
                        <p className="text-xl leading-[1.2] tracking-[-0.04em] [font-family:var(--font-source-serif-4)]">Don’t see your role available? Apply for an open application!</p>
