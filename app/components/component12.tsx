...
export default function component12() {
    ...
    return (
        <div className="flex flex-col items-center gap-10 pt-6 md:pt-10 lg:pt-20 px-5 pb-4 md:pb-6 lg:pb-10 w-full">

            <h2 className="font-medium text-2xl  md:text-[32px] lg:text-[40px] leading-[1] tracking-[-0.03em] [font-family:var(--font-radio-canada-big)]">Latest articles</h2>

            <motion.div variants = {item} initial = "hidden" whileInView = "show" viewport ={{once:true}}  className="grid grid-cols-1 lg:grid-cols-2 pb-10 md:pb-20 lg:pb-30 gap-x-20 md:gap-x-10 lg:gap-x-4 gap-y-20 border-box">
                ...
                <motion.div onClick={()=>router.push("/article/how-to-build-a-climate-ready-data-stack")}  whileHover="hover" transition={{ duration: 0.2, ease: "easeOut" }} className="flex flex-col items-start gap-5 border-box  w-full cursor-pointer">
                    ...
                    <div className="bg-[url('/x12.avif')] bg-cover bg-center aspect-[1.71] w-full"></div>

                    <motion.div className="flex flex-col items-start gap-6 border-box w-full" variants={{ hover: { opacity: 0.6 } }}>

                        <div className="flex flex-col items-start gap-2 border-box">
                            <p className="font-medium text-lg md:text-xl leading-[1] tracking-[-0.02em] [font-family:var(--font-radio-canada-big)]">From Spreadsheets to Systems: The Evolution of Climate Reporting</p>
                            <div className="flex items-start gap-2 border-box">
                        ...
                        <p className="text-lg md:text-xl leading-[1.2] tracking-[-0.04em] [font-family:var(--font-source-serif-4)] ">Why legacy tools aren’t enough—and what the next generation of reporting looks like.</p>
                ...
                <motion.div onClick={()=>router.push("/article/how-to-build-a-climate-ready-data-stack")}  whileHover="hover" transition={{ duration: 0.2, ease: "easeOut" }} className="flex flex-col items-start gap-5 border-box  w-full cursor-pointer">
                    ...
                    <div className="bg-[url('/x13.avif')] bg-cover bg-center aspect-[1.71] w-full"></div>

                    <motion.div className="flex flex-col items-start gap-6 border-box w-full" variants={{ hover: { opacity: 0.6 } }}>

                        <div className="flex flex-col items-start gap-2 border-box">
                            <p className="font-medium text-lg md:text-xl leading-[1] tracking-[-0.02em] [font-family:var(--font-radio-canada-big)]">Carbon Accounting: Myths, Models, and Must-Haves</p>
                            <div className="flex items-start gap-2 border-box">
                                <p className="text-sm leading-[1] [font-family:var(--font-geist-mono)] text-[#6C6C6C]">Tooling</p>
                                <p className="text-sm leading-[1] [font-family:var(--font-geist-mono)] text-[#6C6C6C]">.</p>
                                <p className="text-sm leading-[1] [font-family:var(--font-geist-mono)] text-[#6C6C6C]">6 min</p>
                        ...
                        <p className="text-lg md:text-xl leading-[1.2] tracking-[-0.04em] [font-family:var(--font-source-serif-4)] ">Debunking common assumptions and offering a framework for getting it right.</p>
                ...
                <motion.div onClick={()=>router.push("/article/how-to-build-a-climate-ready-data-stack")}  whileHover="hover" transition={{ duration: 0.2, ease: "easeOut" }} className="flex flex-col items-start gap-5 border-box  w-full cursor-pointer">
                    ...
                    <div className="bg-[url('/x14.avif')] bg-cover bg-center aspect-[1.71] w-full"></div>

                    <motion.div className="flex flex-col items-start gap-6 border-box w-full" variants={{ hover: { opacity: 0.6 } }}>

                        <div className="flex flex-col items-start gap-2 border-box">
                            <p className="font-medium text-lg md:text-xl leading-[1] tracking-[-0.02em] [font-family:var(--font-radio-canada-big)]">Seeing Clearly: Designing Feedback Loops for Sustainable Growth</p>
                            <div className="flex items-start gap-2 border-box">
                                <p className="text-sm leading-[1] [font-family:var(--font-geist-mono)] text-[#6C6C6C]">Strategy</p>
                                <p className="text-sm leading-[1] [font-family:var(--font-geist-mono)] text-[#6C6C6C]">.</p>
                                <p className="text-sm leading-[1] [font-family:var(--font-geist-mono)] text-[#6C6C6C]">4 min</p>
                        ...
                        <p className="text-lg md:text-xl leading-[1.2] tracking-[-0.04em] [font-family:var(--font-source-serif-4)] ">Building responsive systems that keep sustainability strategy adaptive and actionable.</p>
